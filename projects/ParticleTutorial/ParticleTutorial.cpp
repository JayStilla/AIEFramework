...
bool ParticleTutorial::onCreate(int a_argc, char* a_argv[]) 
{
	...
	//Loading shaders
	m_vertShader = Utility::loadShader("shaders/particle.vert", GL_VERTEX_SHADER);
	m_fragShader = Utility::loadShader("shaders/particle.frag", GL_FRAGMENT_SHADER);
...
void ParticleTutorial::CreateShaders()
{
