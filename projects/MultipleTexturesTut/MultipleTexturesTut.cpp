...
MultipleTexturesTut::MultipleTexturesTut()
{
...
bool MultipleTexturesTut::onCreate(int a_argc, char* a_argv[]) 
{
...
void MultipleTexturesTut::onUpdate(float a_deltaTime) 
{
...
int main(int argc, char* argv[])
{
	...
	Application* app = new MultipleTexturesTut();
	
	if (app->create("AIE - MultipleTexturesTut",DEFAULT_SCREENWIDTH,DEFAULT_SCREENHEIGHT,argc,argv) == true)
		app->run();
...
//custom code 
void MultipleTexturesTut::InitFBXSceneResource(FBXFile *a_pScene)
{
...
void MultipleTexturesTut::UpdateFBXSceneResource(FBXFile *a_pScene)
{
	a_pScene->getRoot()->updateGlobalTransform();
}

void MultipleTexturesTut::DestroyFBXSceneResource(FBXFile *a_pScene)
{
