...
Tutorial6::Tutorial6()
: m_particles(nullptr), m_maxParticles(0), m_position(0, 0, 0), m_drawShader(0), m_updateShader(0)
{
	m_vao[0] = 0;
	m_vao[1] = 0;
	m_vbo[0] = 0;
...
void Tutorial6::initialise(unsigned int a_maxParticles, float a_lifespanMin, float a_lifespanMax, float a_velocityMin, float a_velocityMax, float a_startSize, float a_endSize, const glm::vec4& a_startColour, const glm::vec4& a_endColour)
{
...
void Tutorial6::createDrawShader()
{
...
void Tutorial6::createUpdateShader()
{
...
void Tutorial6::draw(const glm::mat4& a_cameraTransform, const glm::mat4& a_projection)
{
